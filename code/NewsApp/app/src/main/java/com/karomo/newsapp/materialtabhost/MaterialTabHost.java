package com.karomo.newsapp.materialtabhost;

/**
 * Created by lawrence on 2/23/15.
 */
...
// custom attributes
                ...
                primaryColor = a.getColor(R.styleable.MaterialTabHost_materialTabsPrimaryColor, Color.parseColor("#03a9f4"));
                accentColor = a.getColor(R.styleable.MaterialTabHost_accentColor,Color.parseColor("#fafafa"));
...
// if device is a tablet and have scrollable tabs add right and left arrows
            ...
            left.setImageDrawable(res.getDrawable(R.mipmap.left_arrow));
...
// set 56 dp width and 48 dp height
            ...
            right.setImageDrawable(res.getDrawable(R.mipmap.right_arrow));
